import os  # Importa la librería os para interacciones con el sistema operativo
...
class ListaDeEstudiantes:
    ...
    def cargar_estudiantes(self, archivo):
        ...
        """
        if os.path.exists(archivo):  # Verifica si el archivo existe antes de intentar cargar
